...
TrilateralSVG.__super__ = trilateralBasic_AppGL;
TrilateralSVG.prototype = $extend(trilateralBasic_AppGL.prototype,{
	draw: function(pen) {
...
function TrilateralSVG_main() {
	...
	haxe_Log.trace("TrilateralSVG example",{ fileName : "TrilateralSVG.hx", lineNumber : 23, className : "_TrilateralSVG.TrilateralSVG_Statics_", methodName : "main"});
}
